...
@interface MKBXBDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBXBDeviceInfoModel *dataModel;

@end

@implementation MKBXBDeviceInfoController
...
- (MKBXBDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBXBDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
