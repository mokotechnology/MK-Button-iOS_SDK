...
@interface MKBXBDeviceInfoModel ()
...
@implementation MKBXBDeviceInfoModel
...
- (BOOL)readMacAddress {
    ...
    [MKBXBInterface bxb_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readBatteryVoltage {
    __block BOOL success = NO;
    [MKBXBInterface bxb_readBatteryVoltageWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKBXBInterface bxb_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKBXBInterface bxb_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKBXBInterface bxb_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKBXBInterface bxb_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKBXBInterface bxb_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManuDate {
    __block BOOL success = NO;
    [MKBXBInterface bxb_readProductionDateWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
