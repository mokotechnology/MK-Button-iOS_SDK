...
@interface MKBXBScanDeviceDataCell ()
...
@implementation MKBXBScanDeviceDataCell

+ (MKBXBScanDeviceDataCell *)initCellWithTableView:(UITableView *)tableView{
    MKBXBScanDeviceDataCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBXBScanDeviceDataCellIdenty"];
    if (!cell) {
        cell = [[MKBXBScanDeviceDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBXBScanDeviceDataCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKBXBScanDataModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBXBScanDataModel.class]) {
        return;
    }
...
- (UIImageView *)rssiIcon{
    if (!_rssiIcon) {
        ...
        _rssiIcon.image = LOADICON(@"MKBeaconXButton", @"MKBXBScanDeviceDataCell", @"bxb_signalIcon.png");
    }
    return _rssiIcon;
}
...
- (UIImageView *)batteryIcon{
    if (!_batteryIcon) {
        ...
        _batteryIcon.image = LOADICON(@"MKBeaconXButton", @"MKBXBScanDeviceDataCell", @"bxb_batteryHighest.png");
    }
    return _batteryIcon;
}
