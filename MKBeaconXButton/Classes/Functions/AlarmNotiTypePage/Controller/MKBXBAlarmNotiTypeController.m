//
//  MKBXBAlarmNotiTypeController.m
...
@interface MKBXBAlarmNotiTypeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKBXBAlarmNotiTypeModel *dataModel;

@end

@implementation MKBXBAlarmNotiTypeController

- (void)dealloc {
    NSLog(@"MKBXBAlarmNotiTypeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKBeaconXButton", @"MKBXBAlarmNotiTypeController", @"bxb_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKBXBNotificationTypePickerView *)headerView {
    if (!_headerView) {
        _headerView = [[MKBXBNotificationTypePickerView alloc] initWithFrame:CGRectMake(0, 0, kViewWidth, 100.f)];
...
- (MKBXBAlarmNotiTypeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBXBAlarmNotiTypeModel alloc] init];
