...
@interface MKBXBAboutController ()
...
@implementation MKBXBAboutController

- (void)dealloc {
    NSLog(@"MKBXBAboutController销毁");
}
...
- (void)loadSubViews {
    ...
    UIImage *image = LOADICON(@"MKBeaconXButton", @"MKBXBScanController", @"bxb_aboutBottomIcon.png");
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKBeaconXButton", @"MKBXBScanController", @"bxb_about_logo.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKBeaconXButton", @"MKBXBScanController", @"bxb_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
