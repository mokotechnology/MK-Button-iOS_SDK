...
@interface MKBXBDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKBXBDFUModule

- (void)dealloc{
    NSLog(@"MKBXBDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKBXBCentralManager shared].peripheral];
}
