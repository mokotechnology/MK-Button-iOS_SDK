//
//  MKBXBUpdateController.m
//  MKLoRaWAN-BXB_Example
//
...
@interface MKBXBUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBXBDFUModule *dfuModule;
...
@implementation MKBXBUpdateController

- (void)dealloc {
    NSLog(@"MKBXBUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bxb_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKBXBCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bxb_centralDeallocNotification" object:nil];
...
- (MKBXBDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKBXBDFUModule alloc] init];
    }
    return _dfuModule;
}
